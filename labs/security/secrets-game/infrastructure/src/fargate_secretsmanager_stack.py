...
class FargateSecretsManagerStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        fargate_vpc = ec2.Vpc.from_lookup(self, "my-default-vpc", is_default=True)
        ...
        secret = sm.Secret(self, "FargateSecret",
            generate_secret_string=sm.SecretStringGenerator(
                secret_string_template=json.dumps({"secretName": "appdemo"}),
        ...
        fargate_container = fargate_task_def.add_container("FargateContainer",
            image=ecs.ContainerImage.from_registry("jbcodeforce/aws-quarkus-secretsmanager-demo:1.0.0"),
            ...
            secrets={ 
                "SECRET_NAME": ecs.Secret.from_secrets_manager(secret, "secretName")
            }
        )
